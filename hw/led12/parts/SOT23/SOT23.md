...
Carries all four LED branches, about 56 mA, so it runs at roughly half its
continuous rating and drops about 0.42 V. That drop is part of the LED current
calculation and is checked in `hw/checks/`.
