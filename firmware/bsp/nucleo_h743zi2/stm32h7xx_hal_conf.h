/**
  ...
  * @brief   HAL configuration for the NUCLEO-H743ZI2 board.
  *          Derived from ST's stm32h7xx_hal_conf_template.h (HAL v1.11.6):
  *          only the modules the firmware uses are enabled, HSE is 8 MHz.
  ******************************************************************************
  * @attention
  *
...
#define HSE_VALUE    (8000000UL) /*!< NUCLEO-H743ZI2: 8 MHz clock from the ST-LINK MCO */
#endif /* HSE_VALUE */
